...
static void register_test_fun(void);
...
static int test(int argc, char **argv)
{
    ...
    printf("cmd=%s,check=%s,time=%d\n", test_args.cmd->sval[0], test_args.check->sval[0], test_args.time->ival[0]);
...
static void register_test(void)
{
    test_args.cmd = arg_str1(NULL, NULL, "<CMD>", "AT CMD");
    test_args.check = arg_str1(NULL, NULL, "<check>", "check BUFF");
    test_args.time = arg_int1(NULL, NULL, "<time>", "time out");
